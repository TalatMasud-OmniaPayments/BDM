...
namespace Omnia.PIE.VTA.ViewModels
{
    ...
    {
        private ObservableCollection<LinkedAccount> _LinkedAccounts;
        public ObservableCollection<LinkedAccount> LinkedAccounts
        {
            get
            {
        ...
        private LinkedAccount _SelectedAccountNumber;
        public LinkedAccount SelectedAccountNumber
        {
            get
            {
                if (_SelectedAccountNumber == null)
                    _SelectedAccountNumber = new LinkedAccount();

                return _SelectedAccountNumber;
            }
            set
            {
                if (value != _SelectedAccountNumber)
                {
